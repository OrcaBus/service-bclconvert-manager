...
import { BclConvertManagerStack } from '../infrastructure/stage/stack';
import { getBclConvertManagerStackProps } from '../infrastructure/stage/config';
...
describe('cdk-nag-stateless-toolchain-stack', () => {
  ...
  const deployStack = new BclConvertManagerStack(app, 'BclConvertManagerStack', {
    // Pick the prod environment to test as it is the most strict
    ...getBclConvertManagerStackProps('PROD'),
    env: {
      account: '123456789',
